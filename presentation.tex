...
%                 \centering
%                 \includegraphics[width=\textwidth]{images/total_loss_nomad.png}
...
%                 \centering
%                 \includegraphics[width=\textwidth]{images/total_loss_vint.png}
...
\begin{frame}{Experiments and Results: UC Multi-Action Cosine Similarity}
    ...
    \end{block}
\end{frame}
>>>>>>> 7ad364b6f7d8900c7d86f060431ec63ca39cfd8c
\end{document}
