...
\end{figure}
\noindent \textbf{gc\_action\_waypts\_cos\_sim (train):}\\
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
...
\noindent \textbf{gc\_action\_multi\_waypts\_cos\_sim (train):}\\
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
...
\begin{itemize}
\item Final training loss: \text 0.003
\item Cosine similarity: \text 0.47 (multi-action waypoints)
\item Distance loss: \text 10.2
\end{itemize}
