...
\begin{itemize}
    ...
    \item \textbf{Appendix E:} Diffusion
    \item \textbf{Appendix F:} Weights and Biases
    \item \textbf{Appendix G:} Team Contributions
...
\bibitem{nomad}
H. Janner et al.,\textit{NOMAD: Planning with Diffusion for Visual Navigation} 2022.
\bibitem{diff}
